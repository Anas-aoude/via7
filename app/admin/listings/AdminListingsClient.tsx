...
const AdminListingsClient = () => {
  ...
  const patchListing = async (
    ...
    axios
      .patch(`/api/admin/listings/${listingId}`, data)
      .then(() => {
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mt-4">Admin Listings</h1>

        <p className="text-neutral-500 mt-2">
          Manage all property listings in VIA7.
        </p>
      </div>
                  ...
                  <td className="p-4">
                    <div className="flex flex-col gap-2 min-w-[130px]">
                      ...
                      <button
                        ...
                        className="text-left text-sm text-red-600 font-semibold hover:underline disabled:opacity-40"
                      >
                        Delete
                      </button>
                    </div>
