...
const manageableUserRoles: UserRole[] = ["USER", "HOST", "VIP_HOST", "AGENCY"];

export default async function ManagerUserListingsPage({
  params,
  searchParams,
}: {
  ...
  if (!currentUser || currentUser.role !== "MANAGER" || currentUser.isBanned) {
    redirect("/");
  }
  ...
  if (!user || !manageableUserRoles.includes(user.role)) {
  ...
  const buildPageUrl = (targetPage: number) => {
    ...
    return `/manager/users/${userId}/listings?${params.toString()}`;
  };
