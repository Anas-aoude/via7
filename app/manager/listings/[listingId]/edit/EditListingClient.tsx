...
const EditListingClient: React.FC<EditListingClientProps> = ({ listing }) => {
  ...
  const changeOwner = async () => {
    ...
    try {
      const response = await axios.patch(
        `/api/manager/listings/${listing.id}/owner`,
        {
  ...
  const onSave = async () => {
    ...
    axios
      .patch(`/api/manager/listings/${listing.id}`, {
        title,
        description,
        price: Number(price),
    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="border rounded-2xl p-6 bg-white">
        ...
        <p className="text-sm text-neutral-500 mb-6">
          Transfer this listing to its real owner.
  </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="button"
            disabled={isSearchingOwner || isChangingOwner}
            onClick={searchOwners}
            className="px-5 py-3 rounded-xl border font-semibold hover:bg-neutral-50 disabled:opacity-50"
          >
            {isSearchingOwner ? "Searching..." : "Search"}
          </button>
        </div>
      ...
      <section className="border rounded-2xl p-6 bg-white">
        <h2 className="text-2xl font-bold mb-6">Manager Controls</h2>
